...
from pf_flask_web.common.pweb_module_operation import PWebModuleOperation
from pf_flask_web.pcli.pweb_module_cli import init_module_cli
...
class PwebBootstrap:
    ...
    _pweb_module_operation = PWebModuleOperation()
    ...
    def _register_modules(self):
        ...
        if module_registry_packages and isinstance(module_registry_packages, list):
            for module_registry_package in module_registry_packages:
                modules = self._pweb_module_operation.get_modules(module_registry_package, self._config)
                if modules:
    ...
    def _pweb_module_cli(self):
        init_module_cli(self._pweb_app, self._config)
